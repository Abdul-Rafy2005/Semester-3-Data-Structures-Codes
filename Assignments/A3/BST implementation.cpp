...
class node
{
    ...
    node* left;
    node* right;
    node(int value) : info(value), count(0), left(nullptr), right(nullptr) {}
};
...
class tree
{
    ...
    int duplicates(node* root, int value);
    void itear_pre();
    void itear_inorder();
    void level_order();
    int count(node *Root);
...
int main() {
    ...
    BST.Insertion(BST.getroot(),nullptr,70);
    BST.Insertion(BST.getroot(),nullptr,40);  // 40 repeats
    BST.Insertion(BST.getroot(),nullptr,60);    // 60 repeats
    BST.Insertion(BST.getroot(),nullptr,20);    
    BST.Insertion(BST.getroot(),nullptr,80);
    BST.Insertion(BST.getroot(),nullptr,40);  // 40 repeats
    ...
    BST.deletion(BST.getroot(),nullptr,30);

    BST.Inorder(BST.getroot());
    cout << endl;

    cout << "Deleting element 70" << endl;
    BST.deletion(BST.getroot(),nullptr,70);

    BST.Inorder(BST.getroot());
    cout << endl;

    cout << BST.duplicates(BST.getroot(),40) << endl;
